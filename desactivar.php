...
<br />
	...
	<div class="col-md-8 col-md-offset-2">
	 		<form method="POST" action="">	
	 				         ...
	 				         <input type="submit" name="Actualizar" class="btn btn-warning" value="DESACTIVAR VIAJE" ><br />
	 			        </div>
	 					<div class="form-group">
			 				<label>Ruta</label>
...
<?php			
	if (isset($_POST['Actualizar'])){
		...
		$consulta = "UPDATE Eliminartabla set ruta = '$ruta', estatus = '$estatus', activo = '0' 
		...
		if ($ejecutar) 
		    {
			echo "<script>alert('Viaje Desactivado')</script>";	
